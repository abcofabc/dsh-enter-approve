...
/** Host loader entry. Declare webServer as a hard dependency so cordis
 * activates this plugin only after the web server service is ready -
 * otherwise apply() would run too early during boot and silently no-op. */
